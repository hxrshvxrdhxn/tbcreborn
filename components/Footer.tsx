      ...
      <div className="container-tbc py-16">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-8">
          ...
          <div>
            ...
            <p className="text-white/40 text-xs leading-relaxed" style={{ maxWidth: "220px" }}>
              AI-Native Management &amp; Technology Consultancy
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-white/60">
              ...
              <li className="text-white/40 text-xs leading-relaxed" style={{ maxWidth: "200px" }}>
                Kasana Tower, Alpha-I Commercial Belt,<br />
              ...
              <li>
                <a
                  ...
                  className="inline-flex items-center gap-1.5 text-tbc-emerald-mid hover:text-tbc-emerald transition-colors duration-150"
                >
        ...
        <div className="mt-12 flex justify-end gap-4">
          <a
            href="https://instagram.com/turbobytesconsulting"
            target="_blank"
            rel="noopener noreferrer"
        ...
        <div className="mt-8 pt-8 border-t border-white/10 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
          <p className="text-white/40 text-xs">
            © 2026 Turbo Bytes Consulting. All rights reserved. · MSME Registered.
          </p>
